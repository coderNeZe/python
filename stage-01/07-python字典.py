...
# d = {[1, 2, 3]: "123"}
# print(d) #报错,列表不能当key  key必须是任意不可变的类型
...
# 不作删除动作
# 如果没有给定默认值, 则报错
v = d.pop("age") #18 {'name': 'fh'}
print(v, d)

v = d.pop("age1", 666) #666 {'name': 'fh'} #不会报错，还是原字典
print(v, d)

# dic.popitem()
# 删除按升序排序后的第一个键值对, 并以元组的形式返回该键值对
# 如果字典为空, 则报错
d = {"name": "fh", "zge": 18, "a": 123}
# d = {}  #如果是空字典调用popitem() 会直接报错
result = d.popitem()
print(result, d)  #删除('a', 123)  结果是 {'name': 'fh', 'zge': 18}
...
#注意和del的区别,clear 是清空字典  而del是直接删除该变量
# del d
# print(d)
